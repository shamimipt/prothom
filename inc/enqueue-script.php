...
function prothom_scripts() {
	...
	wp_enqueue_style( 'prothom-superfish-style', PROTHOM_THEME_URI . 'assets/dist/css/plugins/superfish/css/superfish.css', array(), PROTHOM_VERSION );
	...
	wp_enqueue_script( 'prothom-superfish', PROTHOM_THEME_URI . 'assets/src/js/plugins/superfish/js/superfish.min.js', array( 'jquery' ), PROTHOM_VERSION, true );
	wp_enqueue_script( 'prothom-main', PROTHOM_THEME_URI . 'assets/dist/js/customizer.js', array( 'jquery' ), PROTHOM_VERSION, true );
