...
const FixStyleOnlyEntriesPlugin = require("webpack-fix-style-only-entries"); // Prevent webpack from creating js files for style(scss) entrypoints
...
module.exports = ( projectOptions ) => {
    ...
    return {
        cssRules: cssRules, jsRules: jsRules, imageRules: imageRules, fontRules: fontRules, optimizations: optimizations, plugins: plugins
    }
}
